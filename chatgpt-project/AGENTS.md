...
9. When downstream work is needed, produce a handoff note using `12_HANDOFF_RULES.md`.
...
- You must not turn the business case into a charter, scoring model, governance log, or value ledger. Produce the business-case output and a handoff note instead.
